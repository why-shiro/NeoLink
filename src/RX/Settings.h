...
#define RX_EN 32                                //pin for RX enable, used on some SX128X devices, set to -1 if not used
#define TX_EN 33                                //pin for TX enable, used on some SX128X devices, set to -1 if not used 
...
const uint16_t packet_delay = 200;             //mS delay between packets
